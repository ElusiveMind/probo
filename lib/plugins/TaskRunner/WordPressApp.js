...
class WordPressApp extends LAMPApp {
   ...
   *   @param {string} [options.databaseTablePrefix] - The prefix of the database.
   *      Defaults to 'wp_'.
  ...
  constructor(container, options) {
    ...
    this.options.databaseTablePrefix = options.databaseTablePrefix || "wp_";
  ...
  addScriptAppendWPConfigSettings() {
    this.script = this.script.concat([
      ...
      `\$table_prefix = '${this.options.databaseTablePrefix}'`,
